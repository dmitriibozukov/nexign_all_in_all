...
#### autotests_v1-main - блоки кода, реализованные во время выполнения ДЗ на буткемпе. внутри папки есть README с описанием. Всю директорию добавил дополнительно.
